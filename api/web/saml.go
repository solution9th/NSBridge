...
import (
	...
	"github.com/solution9th/NSBridge/internal/oidc"
...
func SAMLAuth(c *gin.Context) {
	...
	sp = saml.ServiceProviderSettings{
		...
		IDPPublicCertPath:           "/etc/ns_bridge/keys/certs/idp.crt",
		PublicCertPath:              "/etc/ns_bridge/keys/certs/idp.crt",
		PrivateKeyPath:              "/etc/ns_bridge/keys/certs/idp.key",
		SPSignRequest:               true,
