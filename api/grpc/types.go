...
func respJSONReturn(input interface{}) (*httpbody.HttpBody, error) {
...
func respTextReturn(input string) (*httpbody.HttpBody, error) {
...
// Types 获取可以添加的记录类型
func (r *RPCServer) Types(ctx context.Context, in *empty.Empty) (*httpbody.HttpBody, error) {
	...
	return respJSONReturn(result)
}

// LineAll 查看所有线路id列表
func (r *RPCServer) LineAll(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {

	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v,%v,%v,%v,%v,%v]}", lineContinental, lineISP, lineCountry, lineProvince, lineOutCity, lineChinaCityISP)
	return respTextReturn(s)
}

// LineContinental 获得 洲 线路列表
func (r *RPCServer) LineContinental(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {
	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v]}", lineContinental)
	return respTextReturn(s)
}

// LineISP 获得 ISP 线路列表
func (r *RPCServer) LineISP(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {
	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v]}", lineISP)
	return respTextReturn(s)
}

// LineCountry 获得国家线路列表
func (r *RPCServer) LineCountry(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {
	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v]}", lineCountry)
	return respTextReturn(s)
}

// LineProvince 获得省列表
func (r *RPCServer) LineProvince(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {
	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v]}", lineProvince)
	return respTextReturn(s)
}

// LineOutCity 获得国外城市列表
func (r *RPCServer) LineOutCity(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {
	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v]}", lineOutCity)
	return respTextReturn(s)
}

// LineCityIsp 获得国内城市及运营商列表
func (r *RPCServer) LineCityIsp(context.Context, *empty.Empty) (*httpbody.HttpBody, error) {
	s := fmt.Sprintf("{\"err_code\":0,\"err_msg\":\"success\",\"data\":[%v]}", lineChinaCityISP)
	return respTextReturn(s)
}
