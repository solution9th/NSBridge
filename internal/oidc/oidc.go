...
func NewProvider(ctx context.Context, issuer string) (*Provider, error) {
	wellKnown := strings.TrimSuffix(issuer, "/") + "/sso/.well-known/openid-configuration"
	...
	print(issuer)
	print("---------")
	print(issuer + "/sso/oidc/authorize")
	print(issuer + "/sso/oidc/token")
	return &Provider{
		issuer:       p.Issuer,
		authURL:      issuer + "/sso/oidc/authorize", //p.AuthURL,
		tokenURL:     issuer + "/sso/oidc/token",     //p.TokenURL,
